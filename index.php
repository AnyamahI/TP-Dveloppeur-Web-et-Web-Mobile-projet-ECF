...
<body>
    ...
    <header>
        <nav>
            <div class="logo">
            <a href="/html/index.html"><img src="/média/Logo_Arcadia_Transparent_V2.png" alt=""></a>
            </div>
            ...
            <ul class="menu">
                ...
                <li><a href="/page animaux/animaux.html">Animaux</a></li>
    ...
    <section class="sec2">
        ...
        <div class="container">
            ...
            <div class="shap-divider">
                <img src="/média/shap_divider_vert.png" alt="">
            </div>
            ...
            <div class="container-intro">
                ...
                <img src="/média/furret-removebg.png" alt="">
    ...
    <section class="sec3">
            ...
            <div class="container-savane">
                ...
                <div class="savane-blop">
                    <img src="/média/Blop-Savane.png" alt="">
                </div>
            ...
            <div class="container-jungle">
                ...
                <div class="jungle-blop">
                    <img src="/média/Blop-Jungle.png" alt="">
                </div>
            ...
            <div class="container-marais">
                ...
                <div class="marais-blop">
                    <img src="/média/Blop-Marais.png" alt="">
                </div>
    ...
    <section class="sec4">
        ...
        <div class="container-animaux">
            <div class="container-tigre_loup">
                <img class="tigre" src="/média/Tigre_acceuil-unsplash.jpg" alt="">
                <img class="loup" src="/média/loup_acceuil-unsplash.jpg" alt="">
            </div>
            <div class="container-zebre_goril_loutre">
                <img class="zebre" src="/média/zebre-acceuil-unsplash.jpg " alt="">
    ...
    <section class="sec5">
        ...
        <div class="avis">
            <img src="/média/avis-prototype.png" alt="">
        </div>
    ...
    <section class="sec6">
        ...
        <div class="partenaire">
            <img class="logo_BornFree" src="/média/logo-Born-free.png" alt="">
            <img class="logo_SPA" src="/média/logo-SPA.png" alt="">
            <img class="logo_WWF" src="/média/Panda_contours_only.png" alt="">
            <img class="logo_AFDPZ" src="/média/AFDPZ_logo_bg_vide.png" alt="">
        </div>
    </section>
    ...
    <div class="contact" id="contact"></div>
        ...
        <footer>MON PROJET ARCADIA</footer>
    </section>
</body>
</html>